 ...
 * <p/>
 * Very similar to DataInputStream except it reads little-endian instead of big-endian binary data. We can't extend
 * DataInputStream directly since it has only final methods, though DataInputStream itself is not final. This forces us
 * implement LEDataInputStream with a DataInputStream object, and use wrapper methods.
 *
