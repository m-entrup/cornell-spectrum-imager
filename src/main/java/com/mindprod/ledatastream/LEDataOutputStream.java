 ...
 * <p/>
 * Very similar to DataOutputStream except it writes little-endian instead of big-endian binary data. We can't extend
 * DataOutputStream directly since it has only final methods. This forces us implement LEDataOutputStream with a
