...
public final class LERandomAccessFile implements DataInput, DataOutput {
     ...
     *            file to read/write.
     * @param rw
     *            like {@link java.io.RandomAccessFile} where "r" for read "rw" for read and write, "rws" for read-write
     *            sync, and "rwd" for read-write dsync. Sync ensures the physical I/O has completed befor the method
     *            returns.
     *
     ...
     *
     * @param ba
     *            byte array to accept teh bytes.
     * @param off
     *            offset into the array to place the bytes, <strong>not</strong> offset in file.
     * @param len
